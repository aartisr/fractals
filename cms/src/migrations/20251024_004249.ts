...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_live_streams_visibility" AS ENUM('public', 'private');
  ...
  CREATE TABLE "live_streams" (
  	...
  	"visibility" "enum_live_streams_visibility" DEFAULT 'private' NOT NULL,
  	"status" "enum_live_streams_status" DEFAULT 'idle' NOT NULL,
  	"rtmp_url" varchar,
  	"master_playlist_url" varchar,
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_live_streams_fk" FOREIGN KEY ("live_streams_id") REFERENCES "public"."live_streams"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "live_streams_stream_key_idx" ON "live_streams" USING btree ("stream_key");
  CREATE INDEX "live_streams_updated_at_idx" ON "live_streams" USING btree ("updated_at");
  CREATE INDEX "live_streams_created_at_idx" ON "live_streams" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_live_streams_id_idx" ON "payload_locked_documents_rels" USING btree ("live_streams_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "live_streams" CASCADE;
  ...
  DROP TYPE "public"."enum_live_streams_visibility";
